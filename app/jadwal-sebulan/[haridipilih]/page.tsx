...
export default async function HariDipilih({ params }: Props) {
	...
	return (
		<div className="h-full w-full">
			<div className="w-full h-full flex flex-col bg-linear-to-br from-[#434897]/60 via-[#191E24] to-[#434897]/60 border-2 border-indigo-800 rounded-[1.25rem]">
				<div className="w-full h-full flex flex-col bg-linear-to-bl from-[#191E2480] to-[#4E83C31A] py-15 rounded-[1.25rem] ">
					...
					<div className="flex flex-col justify-center items-center lg:flex-row flex-wrap xl:gap-16 xl:px-24 py-20">
						<div
							...
							aria-label="Waktu salat subuh hari ini"
						>
							<div className="flex flex-col justify-center items-center xl:items-start">
								...
								<hr className="lg:hidden my-8 w-38.75 rounded-xs h-0.5 bg-linear-to-r from-bluetransparent via-blueopaque to-bluetransparent" />
							</div>
							<hr className="hidden lg:rotate-180 lg:rounded-full lg:flex lg:w-0.5 lg:h-38.75 lg:bg-linear-to-b lg:from-bluetransparent lg:via-blueopaque lg:to-bluetransparent" />
						</div>
						<div
							className="flex gap-16"
							aria-label="Waktu salat dzuhur hari ini"
						>
							<div className="flex flex-col justify-center items-center xl:items-start">
						...
						<div
							className="flex gap-16"
							aria-label="Waktu salat ashar hari ini"
						>
							<div className="flex flex-col justify-center items-center xl:items-start">
